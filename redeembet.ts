...
async function main() {
  ...
  console.log(`Azuro Protocol withdraw on Polygon`);
  console.log('-'.repeat(60) + '\n');

  // Call withdrawEstimateTx() to fetch quote and messages
  ...
  // Sign messages from withdrawEstimateTx() response to generate signatures
  const signatures = {
